...
namespace Cataclysmic
{
    public class Player : Entity
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!Game1.self.timeTraveling)
            {
                GamePadState gamePad = GamePad.GetState(PlayerIndex.One);
                moveData.deltaTime = (float)gameTime.ElapsedGameTime.TotalSeconds;
                GetVelocity(gameTime, gamePad);

                int MouseX = (int)Game1.self.cursor.Position.X;
                int MouseY = (int)Game1.self.cursor.Position.Y;
            ...
            {
                if (!Game1.self.timeTraveling || abilWrap is TimeWrapper)
        ...
        {
            // Health Bar
            Game1.self.spriteBatch.Draw(Game1.texture_blank, new Rectangle(219, 922, 350, 60), Color.Black);
            //Game1.self.spriteBatch.Draw(Game1.texture_blank, new Rectangle(219, 922, 1+(int)(350 * healthData.lerpValue), 60), Color.Green);
            Game1.self.spriteBatch.Draw(Game1.texture_wave, new Rectangle(200 - (int)(400 * (1-healthData.lerpValue)), 922, 400, 70), new Rectangle(0, (int)(Game1.timer*0.3)%(Game1.texture_wave.Height-35), 400, 35), new Color(143, 23, 23));

            // Mana Bar
            Game1.self.spriteBatch.Draw(Game1.texture_blank, new Rectangle(219, 1003, 350, 60), Color.Black);
            Game1.self.spriteBatch.Draw(Game1.texture_wave, new Rectangle(200 - (int)(400 * (1 - timeEnergy.lerpValue)), 1003, 400, 70), new Rectangle(0, (int)(Game1.timer*0.5+50) % (Game1.texture_wave.Height - 35), 400, 35), new Color(125, 83, 170));
